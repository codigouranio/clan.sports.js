        ...
        >
          ...
          >
            <Box maxWidth="250px" mx="auto">
              <Image
                  src={ logo }
                  alt="Logo Clan Sports"
                  width={ 150 }
                  height={ 150 }
              />
            </Box>

            <ButtonGoogle marginTop="5px"/>
            ...
            <Box marginTop="70px">
              ...
              <Button rightIcon={<FiLogIn/>} variant="solid" colorScheme="clan" marginTop="15px">Login</Button>
            </Box>
          </Box>
        </Center>
      </MainLayout>
